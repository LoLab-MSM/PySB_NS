# exported from PySB model 'model_101'
...
Monomer('BAR', ['C8A'])
Monomer('Apop', ['XIAP', 'C3pro', 'C3A'])
Monomer('BaxM', ['BidM', 'BaxA'])
Monomer('C8A', ['BAR', 'BidU', 'C3A'])
...
Rule('ApafA_C9_conversion_Apop_0', ApafA() + C9() <> Apop(XIAP=None, C3pro=None, C3A=None), ApafA_C9_conversion_Apop_0_2kf, ApafA_C9_conversion_Apop_0_1kr)
Rule('XIAP_inhibition_Apop_0', XIAP(Apop=None, SmacA=None, C3A=None) + Apop(XIAP=None, C3pro=None, C3A=None) <> XIAP(Apop=1, SmacA=None, C3A=None) % Apop(XIAP=1, C3pro=None, C3A=None), XIAP_inhibition_Apop_0_2kf, XIAP_inhibition_Apop_0_1kr)
Rule('BAR_inhibition_C8A_0', BAR(C8A=None) + C8A(BAR=None, BidU=None, C3A=None) <> BAR(C8A=1) % C8A(BAR=1, BidU=None, C3A=None), BAR_inhibition_C8A_0_2kf, BAR_inhibition_C8A_0_1kr)
Rule('C6A_C8pro_catalysis_C8A_0', C6A(C8pro=1) % C8pro(C6A=1, DISC=None) >> C6A(C8pro=None) + C8A(BAR=None, BidU=None, C3A=None), C6A_C8pro_catalysis_C8A_0_1kc)
...
Rule('C8A_BidU_catalysis_BidT_0', C8A(BAR=None, BidU=1, C3A=None) % BidU(C8A=1) >> C8A(BAR=None, BidU=None, C3A=None) + BidT(), C8A_BidU_catalysis_BidT_0_1kc)
Rule('C8A_substrate_binding_BidU_0', C8A(BAR=None, BidU=None, C3A=None) + BidU(C8A=None) <> C8A(BAR=None, BidU=1, C3A=None) % BidU(C8A=1), C8A_substrate_binding_BidU_0_2kf, C8A_substrate_binding_BidU_0_1kr)
Rule('Apop_C3pro_catalysis_C3A_0', Apop(XIAP=None, C3pro=1, C3A=None) % C3pro(Apop=1) >> Apop(XIAP=None, C3pro=None, C3A=None) + C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None, C8A=None), Apop_C3pro_catalysis_C3A_0_1kc)
Rule('Apop_substrate_binding_C3A_0', Apop(XIAP=None, C3pro=None, C3A=None) + C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None, C8A=None) <> Apop(XIAP=None, C3pro=None, C3A=1) % C3A(XIAP=None, PARPU=None, C6pro=None, Apop=1, C8A=None), Apop_substrate_binding_C3A_0_2kf, Apop_substrate_binding_C3A_0_1kr)
Rule('C8A_substrate_binding_C3A_0', C8A(BAR=None, BidU=None, C3A=None) + C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None, C8A=None) <> C8A(BAR=None, BidU=None, C3A=1) % C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None, C8A=1), C8A_substrate_binding_C3A_0_2kf, C8A_substrate_binding_C3A_0_1kr)
Rule('Apop_substrate_binding_C3pro_0', Apop(XIAP=None, C3pro=None, C3A=None) + C3pro(Apop=None) <> Apop(XIAP=None, C3pro=1, C3A=None) % C3pro(Apop=1), Apop_substrate_binding_C3pro_0_2kf, Apop_substrate_binding_C3pro_0_1kr)
...
Initial(Apop(XIAP=None, C3pro=None, C3A=None), Apop_0)
Initial(BaxM(BidM=None, BaxA=None), BaxM_0)
Initial(C8A(BAR=None, BidU=None, C3A=None), C8A_0)
