# exported from PySB model 'model_104'
...
Rule('Apop_C3pro_catalysis_C8A_0', Apop(XIAP=None, C3pro=1) % C3pro(Apop=1, C8A=None) >> Apop(XIAP=None, C3pro=None) + C8A(BAR=None, BidU=None, C3pro=None), Apop_C3pro_catalysis_C8A_0_1kc)
