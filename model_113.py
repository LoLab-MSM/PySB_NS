# exported from PySB model 'model_113'
...
Monomer('Mcl1M', ['BakA', 'BidM', 'BclxLM', 'NoxaM'])
Monomer('ApafI', ['CytoCA'])
Monomer('Bcl2', ['BaxA', 'BidM', 'BadM'])
Monomer('BidU', ['C8A'])
Monomer('BidT')
Monomer('C3A', ['XIAP', 'PARPU', 'C6pro', 'Apop', 'C8A'])
Monomer('flip', ['DISC'])
Monomer('ApafA')
Monomer('BidM', ['BakM', 'BaxM', 'Mcl1M', 'Bcl2'])
...
Parameter('C8A_substrate_binding_C3A_0_2kf', 1.0)
Parameter('C8A_substrate_binding_C3A_0_1kr', 1.0)
...
Parameter('BclxLM_inhibition_Mcl1M_0_2kf', 1.0)
Parameter('BclxLM_inhibition_Mcl1M_0_1kr', 1.0)
...
Rule('BAR_inhibition_C8A_0', BAR(C8A=None) + C8A(BAR=None, BidU=None, C3pro=None, C3A=None) <> BAR(C8A=1) % C8A(BAR=1, BidU=None, C3pro=None, C3A=None), BAR_inhibition_C8A_0_2kf, BAR_inhibition_C8A_0_1kr)
Rule('C6A_C8pro_catalysis_C8A_0', C6A(C8pro=1) % C8pro(C6A=1, DISC=None) >> C6A(C8pro=None) + C8A(BAR=None, BidU=None, C3pro=None, C3A=None), C6A_C8pro_catalysis_C8A_0_1kc)
...
Rule('BclxLC_equilibration_BclxLM_0', BclxLC() <> BclxLM(BakA=None, BaxA=None, Mcl1M=None, BadM=None), BclxLC_equilibration_BclxLM_0_1kf, BclxLC_equilibration_BclxLM_0_1kr)
...
Rule('C3A_XIAP_catalysis_C3ub_0', XIAP(Apop=None, SmacA=None, C3A=1) % C3A(XIAP=1, PARPU=None, C6pro=None, Apop=None, C8A=None) >> XIAP(Apop=None, SmacA=None, C3A=None) + C3ub(), C3A_XIAP_catalysis_C3ub_0_1kc)
Rule('XIAP_substrate_binding_C3A_0', XIAP(Apop=None, SmacA=None, C3A=None) + C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None, C8A=None) <> XIAP(Apop=None, SmacA=None, C3A=1) % C3A(XIAP=1, PARPU=None, C6pro=None, Apop=None, C8A=None), XIAP_substrate_binding_C3A_0_2kf, XIAP_substrate_binding_C3A_0_1kr)
Rule('C3A_PARPU_catalysis_PARPC_0', C3A(XIAP=None, PARPU=1, C6pro=None, Apop=None, C8A=None) % PARPU(C3A=1) >> C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None, C8A=None) + PARPC(), C3A_PARPU_catalysis_PARPC_0_1kc)
Rule('C3A_substrate_binding_PARPU_0', C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None, C8A=None) + PARPU(C3A=None) <> C3A(XIAP=None, PARPU=1, C6pro=None, Apop=None, C8A=None) % PARPU(C3A=1), C3A_substrate_binding_PARPU_0_2kf, C3A_substrate_binding_PARPU_0_1kr)
Rule('C3A_C6pro_catalysis_C6A_0', C3A(XIAP=None, PARPU=None, C6pro=1, Apop=None, C8A=None) % C6pro(C3A=1) >> C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None, C8A=None) + C6A(C8pro=None), C3A_C6pro_catalysis_C6A_0_1kc)
Rule('C3A_substrate_binding_C6pro_0', C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None, C8A=None) + C6pro(C3A=None) <> C3A(XIAP=None, PARPU=None, C6pro=1, Apop=None, C8A=None) % C6pro(C3A=1), C3A_substrate_binding_C6pro_0_2kf, C3A_substrate_binding_C6pro_0_1kr)
...
Rule('BidM_BakM_catalysis_BakA_0', BidM(BakM=1, BaxM=None, Mcl1M=None, Bcl2=None) % BakM(BidM=1, BakA=None) >> BidM(BakM=None, BaxM=None, Mcl1M=None, Bcl2=None) + BakA(BakA_1=None, BakA_2=None, SmacM=None, CytoCM=None, BclxLM=None, Mcl1M=None, BakM=None), BidM_BakM_catalysis_BakA_0_1kc)
Rule('BclxLM_inhibition_BakA_0', BclxLM(BakA=None, BaxA=None, Mcl1M=None, BadM=None) + BakA(BakA_1=None, BakA_2=None, SmacM=None, CytoCM=None, BclxLM=None, Mcl1M=None, BakM=None) <> BclxLM(BakA=1, BaxA=None, Mcl1M=None, BadM=None) % BakA(BakA_1=None, BakA_2=None, SmacM=None, CytoCM=None, BclxLM=1, Mcl1M=None, BakM=None), BclxLM_inhibition_BakA_0_2kf, BclxLM_inhibition_BakA_0_1kr)
Rule('Mcl1M_inhibition_BakA_0', Mcl1M(BakA=None, BidM=None, BclxLM=None, NoxaM=None) + BakA(BakA_1=None, BakA_2=None, SmacM=None, CytoCM=None, BclxLM=None, Mcl1M=None, BakM=None) <> Mcl1M(BakA=1, BidM=None, BclxLM=None, NoxaM=None) % BakA(BakA_1=None, BakA_2=None, SmacM=None, CytoCM=None, BclxLM=None, Mcl1M=1, BakM=None), Mcl1M_inhibition_BakA_0_2kf, Mcl1M_inhibition_BakA_0_1kr)
Rule('BidM_substrate_binding_BakM_0', BidM(BakM=None, BaxM=None, Mcl1M=None, Bcl2=None) + BakM(BidM=None, BakA=None) <> BidM(BakM=1, BaxM=None, Mcl1M=None, Bcl2=None) % BakM(BidM=1, BakA=None), BidM_substrate_binding_BakM_0_2kf, BidM_substrate_binding_BakM_0_1kr)
Rule('BaxM_BidM_catalysis_BaxA_0', BidM(BakM=None, BaxM=1, Mcl1M=None, Bcl2=None) % BaxM(BidM=1, BaxA=None) >> BidM(BakM=None, BaxM=None, Mcl1M=None, Bcl2=None) + BaxA(BaxA_1=None, BaxA_2=None, SmacM=None, CytoCM=None, BclxLM=None, Bcl2=None, BaxM=None), BaxM_BidM_catalysis_BaxA_0_1kc)
Rule('BclxLM_inhibition_BaxA_0', BclxLM(BakA=None, BaxA=None, Mcl1M=None, BadM=None) + BaxA(BaxA_1=None, BaxA_2=None, SmacM=None, CytoCM=None, BclxLM=None, Bcl2=None, BaxM=None) <> BclxLM(BakA=None, BaxA=1, Mcl1M=None, BadM=None) % BaxA(BaxA_1=None, BaxA_2=None, SmacM=None, CytoCM=None, BclxLM=1, Bcl2=None, BaxM=None), BclxLM_inhibition_BaxA_0_2kf, BclxLM_inhibition_BaxA_0_1kr)
...
Rule('BidM_substrate_binding_BaxM_0', BidM(BakM=None, BaxM=None, Mcl1M=None, Bcl2=None) + BaxM(BidM=None, BaxA=None) <> BidM(BakM=None, BaxM=1, Mcl1M=None, Bcl2=None) % BaxM(BidM=1, BaxA=None), BidM_substrate_binding_BaxM_0_2kf, BidM_substrate_binding_BaxM_0_1kr)
Rule('C8A_BidU_catalysis_BidT_0', C8A(BAR=None, BidU=1, C3pro=None, C3A=None) % BidU(C8A=1) >> C8A(BAR=None, BidU=None, C3pro=None, C3A=None) + BidT(), C8A_BidU_catalysis_BidT_0_1kc)
Rule('C8A_substrate_binding_BidU_0', C8A(BAR=None, BidU=None, C3pro=None, C3A=None) + BidU(C8A=None) <> C8A(BAR=None, BidU=1, C3pro=None, C3A=None) % BidU(C8A=1), C8A_substrate_binding_BidU_0_2kf, C8A_substrate_binding_BidU_0_1kr)
Rule('C8A_C3pro_catalysis_C3A_0', C8A(BAR=None, BidU=None, C3pro=1, C3A=None) % C3pro(C8A=1) >> C8A(BAR=None, BidU=None, C3pro=None, C3A=None) + C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None, C8A=None), C8A_C3pro_catalysis_C3A_0_1kc)
Rule('Apop_substrate_binding_C3A_0', Apop(XIAP=None, C3A=None) + C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None, C8A=None) <> Apop(XIAP=None, C3A=1) % C3A(XIAP=None, PARPU=None, C6pro=None, Apop=1, C8A=None), Apop_substrate_binding_C3A_0_2kf, Apop_substrate_binding_C3A_0_1kr)
Rule('C8A_substrate_binding_C3A_0', C8A(BAR=None, BidU=None, C3pro=None, C3A=None) + C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None, C8A=None) <> C8A(BAR=None, BidU=None, C3pro=None, C3A=1) % C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None, C8A=1), C8A_substrate_binding_C3A_0_2kf, C8A_substrate_binding_C3A_0_1kr)
Rule('C8A_substrate_binding_C3pro_0', C8A(BAR=None, BidU=None, C3pro=None, C3A=None) + C3pro(C8A=None) <> C8A(BAR=None, BidU=None, C3pro=1, C3A=None) % C3pro(C8A=1), C8A_substrate_binding_C3pro_0_2kf, C8A_substrate_binding_C3pro_0_1kr)
...
Rule('Mcl1M_inhibition_BidM_0', Mcl1M(BakA=None, BidM=None, BclxLM=None, NoxaM=None) + BidM(BakM=None, BaxM=None, Mcl1M=None, Bcl2=None) <> Mcl1M(BakA=None, BidM=1, BclxLM=None, NoxaM=None) % BidM(BakM=None, BaxM=None, Mcl1M=1, Bcl2=None), Mcl1M_inhibition_BidM_0_2kf, Mcl1M_inhibition_BidM_0_1kr)
Rule('Bcl2_inhibition_BidM_0', Bcl2(BaxA=None, BidM=None, BadM=None) + BidM(BakM=None, BaxM=None, Mcl1M=None, Bcl2=None) <> Bcl2(BaxA=None, BidM=1, BadM=None) % BidM(BakM=None, BaxM=None, Mcl1M=None, Bcl2=1), Bcl2_inhibition_BidM_0_2kf, Bcl2_inhibition_BidM_0_1kr)
Rule('BidT_equilibration_BidM_0', BidT() <> BidM(BakM=None, BaxM=None, Mcl1M=None, Bcl2=None), BidT_equilibration_BidM_0_1kf, BidT_equilibration_BidM_0_1kr)
Rule('BclxLM_inhibition_Mcl1M_0', BclxLM(BakA=None, BaxA=None, Mcl1M=None, BadM=None) + Mcl1M(BakA=None, BidM=None, BclxLM=None, NoxaM=None) <> BclxLM(BakA=None, BaxA=None, Mcl1M=1, BadM=None) % Mcl1M(BakA=None, BidM=None, BclxLM=1, NoxaM=None), BclxLM_inhibition_Mcl1M_0_2kf, BclxLM_inhibition_Mcl1M_0_1kr)
...
Rule('BclxLM_inhibition_BadM_0', BclxLM(BakA=None, BaxA=None, Mcl1M=None, BadM=None) + BadM(BclxLM=None, Bcl2=None) <> BclxLM(BakA=None, BaxA=None, Mcl1M=None, BadM=1) % BadM(BclxLM=1, Bcl2=None), BclxLM_inhibition_BadM_0_2kf, BclxLM_inhibition_BadM_0_1kr)
...
Rule('NoxaM_inhibition_Mcl1M_0', NoxaM(Mcl1M=None) + Mcl1M(BakA=None, BidM=None, BclxLM=None, NoxaM=None) <> NoxaM(Mcl1M=1) % Mcl1M(BakA=None, BidM=None, BclxLM=None, NoxaM=1), NoxaM_inhibition_Mcl1M_0_2kf, NoxaM_inhibition_Mcl1M_0_1kr)

Initial(BAR(C8A=None), BAR_0)
Initial(Apop(XIAP=None, C3A=None), Apop_0)
Initial(BaxM(BidM=None, BaxA=None), BaxM_0)
Initial(C8A(BAR=None, BidU=None, C3pro=None, C3A=None), C8A_0)
...
Initial(BclxLM(BakA=None, BaxA=None, Mcl1M=None, BadM=None), BclxLM_0)
...
Initial(Mcl1M(BakA=None, BidM=None, BclxLM=None, NoxaM=None), Mcl1M_0)
Initial(ApafI(CytoCA=None), ApafI_0)
Initial(Bcl2(BaxA=None, BidM=None, BadM=None), Bcl2_0)
Initial(BidU(C8A=None), BidU_0)
Initial(BidT(), BidT_0)
Initial(C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None, C8A=None), C3A_0)
Initial(flip(DISC=None), flip_0)
Initial(ApafA(), ApafA_0)
Initial(BidM(BakM=None, BaxM=None, Mcl1M=None, Bcl2=None), BidM_0)
