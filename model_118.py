# exported from PySB model 'model_118'
...
Rule('Apop_C3pro_catalysis_C3A_0', Apop(XIAP=None, C3pro=1, C3A=None) % C3pro(Apop=1, C8A=None) >> Apop(XIAP=None, C3pro=None, C3A=None) + C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None), Apop_C3pro_catalysis_C3A_0_1kc)
Rule('Apop_substrate_binding_C3A_0', Apop(XIAP=None, C3pro=None, C3A=None) + C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None) <> Apop(XIAP=None, C3pro=None, C3A=1) % C3A(XIAP=None, PARPU=None, C6pro=None, Apop=1), Apop_substrate_binding_C3A_0_2kf, Apop_substrate_binding_C3A_0_1kr)
Rule('Apop_substrate_binding_C3pro_0', Apop(XIAP=None, C3pro=None, C3A=None) + C3pro(Apop=None, C8A=None) <> Apop(XIAP=None, C3pro=1, C3A=None) % C3pro(Apop=1, C8A=None), Apop_substrate_binding_C3pro_0_2kf, Apop_substrate_binding_C3pro_0_1kr)
