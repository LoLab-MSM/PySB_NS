# exported from PySB model 'model_119'
...
Monomer('C8A', ['BAR', 'BidU', 'C3A', 'C3pro'])
...
Rule('BAR_inhibition_C8A_0', BAR(C8A=None) + C8A(BAR=None, BidU=None, C3A=None, C3pro=None) <> BAR(C8A=1) % C8A(BAR=1, BidU=None, C3A=None, C3pro=None), BAR_inhibition_C8A_0_2kf, BAR_inhibition_C8A_0_1kr)
Rule('C6A_C8pro_catalysis_C8A_0', C6A(C8pro=1) % C8pro(C6A=1, DISC=None) >> C6A(C8pro=None) + C8A(BAR=None, BidU=None, C3A=None, C3pro=None), C6A_C8pro_catalysis_C8A_0_1kc)
...
Rule('C8A_BidU_catalysis_BidT_0', C8A(BAR=None, BidU=1, C3A=None, C3pro=None) % BidU(C8A=1) >> C8A(BAR=None, BidU=None, C3A=None, C3pro=None) + BidT(), C8A_BidU_catalysis_BidT_0_1kc)
Rule('C8A_substrate_binding_BidU_0', C8A(BAR=None, BidU=None, C3A=None, C3pro=None) + BidU(C8A=None) <> C8A(BAR=None, BidU=1, C3A=None, C3pro=None) % BidU(C8A=1), C8A_substrate_binding_BidU_0_2kf, C8A_substrate_binding_BidU_0_1kr)
Rule('Apop_C3pro_catalysis_C3A_0', Apop(XIAP=None, C3pro=1) % C3pro(Apop=1, C8A=None) >> Apop(XIAP=None, C3pro=None) + C3A(XIAP=None, PARPU=None, C6pro=None, C8A=None), Apop_C3pro_catalysis_C3A_0_1kc)
Rule('C8A_substrate_binding_C3A_0', C8A(BAR=None, BidU=None, C3A=None, C3pro=None) + C3A(XIAP=None, PARPU=None, C6pro=None, C8A=None) <> C8A(BAR=None, BidU=None, C3A=1, C3pro=None) % C3A(XIAP=None, PARPU=None, C6pro=None, C8A=1), C8A_substrate_binding_C3A_0_2kf, C8A_substrate_binding_C3A_0_1kr)
...
Rule('C8A_substrate_binding_C3pro_0', C8A(BAR=None, BidU=None, C3A=None, C3pro=None) + C3pro(Apop=None, C8A=None) <> C8A(BAR=None, BidU=None, C3A=None, C3pro=1) % C3pro(Apop=None, C8A=1), C8A_substrate_binding_C3pro_0_2kf, C8A_substrate_binding_C3pro_0_1kr)
...
Initial(C8A(BAR=None, BidU=None, C3A=None, C3pro=None), C8A_0)
