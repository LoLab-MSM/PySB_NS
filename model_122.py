# exported from PySB model 'model_122'
...
Rule('ApafA_C9_conversion_Apop_0', ApafA() + C9() <> Apop(XIAP=None, C3A=None, C3pro=None), ApafA_C9_conversion_Apop_0_2kf, ApafA_C9_conversion_Apop_0_1kr)
Rule('XIAP_inhibition_Apop_0', XIAP(Apop=None, SmacA=None, C3A=None) + Apop(XIAP=None, C3A=None, C3pro=None) <> XIAP(Apop=1, SmacA=None, C3A=None) % Apop(XIAP=1, C3A=None, C3pro=None), XIAP_inhibition_Apop_0_2kf, XIAP_inhibition_Apop_0_1kr)
...
Rule('C8A_C3pro_catalysis_C3A_0', C8A(BAR=None, BidU=None, C3pro=1) % C3pro(C8A=1, Apop=None) >> C8A(BAR=None, BidU=None, C3pro=None) + C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None), C8A_C3pro_catalysis_C3A_0_1kc)
Rule('Apop_substrate_binding_C3A_0', Apop(XIAP=None, C3A=None, C3pro=None) + C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None) <> Apop(XIAP=None, C3A=1, C3pro=None) % C3A(XIAP=None, PARPU=None, C6pro=None, Apop=1), Apop_substrate_binding_C3A_0_2kf, Apop_substrate_binding_C3A_0_1kr)
Rule('Apop_substrate_binding_C3pro_0', Apop(XIAP=None, C3A=None, C3pro=None) + C3pro(C8A=None, Apop=None) <> Apop(XIAP=None, C3A=None, C3pro=1) % C3pro(C8A=None, Apop=1), Apop_substrate_binding_C3pro_0_2kf, Apop_substrate_binding_C3pro_0_1kr)
...
Initial(Apop(XIAP=None, C3A=None, C3pro=None), Apop_0)
