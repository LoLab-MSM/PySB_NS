# exported from PySB model 'model_155'
...
Rule('DISC_C8pro_catalysis_C8A_0', DISC(C8pro=1, flip=None) % C8pro(DISC=1, C6A=None) >> DISC(C8pro=None, flip=None) + C8A(BAR=None, BidU=None, C3A=None, C3pro=None), DISC_C8pro_catalysis_C8A_0_1kc)
