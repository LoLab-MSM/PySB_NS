# exported from PySB model 'model_190'
...
Rule('C6A_C8pro_catalysis_C8A_0', C6A(C8pro=1) % C8pro(DISC=None, C6A=1) >> C6A(C8pro=None) + C8A(BAR=None, BidU=None, C3pro=None, C3A=None), C6A_C8pro_catalysis_C8A_0_1kc)
