# exported from PySB model 'model_193'
...
Rule('DISC_C8pro_catalysis_C6A_0', DISC(C8pro=1, flip=None) % C8pro(DISC=1, C6A=None) >> DISC(C8pro=None, flip=None) + C6A(C8pro=None), DISC_C8pro_catalysis_C6A_0_1kc)
