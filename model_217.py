# exported from PySB model 'model_217'
...
Rule('C6A_C8pro_catalysis_C8A_0', C6A(C8pro=1) % C8pro(C6A=1, DISC=None) >> C6A(C8pro=None) + C8A(BidU=None, C3A=None), C6A_C8pro_catalysis_C8A_0_1kc)
...
Rule('C8A_BidU_catalysis_BidT_0', C8A(BidU=1, C3A=None) % BidU(C8A=1) >> C8A(BidU=None, C3A=None) + BidT(), C8A_BidU_catalysis_BidT_0_1kc)
Rule('C8A_substrate_binding_BidU_0', C8A(BidU=None, C3A=None) + BidU(C8A=None) <> C8A(BidU=1, C3A=None) % BidU(C8A=1), C8A_substrate_binding_BidU_0_2kf, C8A_substrate_binding_BidU_0_1kr)
...
Rule('C8A_substrate_binding_C3A_0', C8A(BidU=None, C3A=None) + C3A(XIAP=None, PARPU=None, C6pro=None, C8A=None) <> C8A(BidU=None, C3A=1) % C3A(XIAP=None, PARPU=None, C6pro=None, C8A=1), C8A_substrate_binding_C3A_0_2kf, C8A_substrate_binding_C3A_0_1kr)
...
Initial(C8A(BidU=None, C3A=None), C8A_0)
