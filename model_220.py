# exported from PySB model 'model_220'
...
Parameter('BAR_inhibition_DISC_0_2kf', 1.0)
Parameter('BAR_inhibition_DISC_0_1kr', 1.0)
...
Rule('C6A_C8pro_catalysis_C8A_0', C6A(C8pro=1) % C8pro(C6A=1, DISC=None) >> C6A(C8pro=None) + C8A(BidU=None, C3pro=None), C6A_C8pro_catalysis_C8A_0_1kc)
Rule('DISC_substrate_binding_C8pro_0', DISC(C8pro=None, BAR=None, flip=None) + C8pro(C6A=None, DISC=None) <> DISC(C8pro=1, BAR=None, flip=None) % C8pro(C6A=None, DISC=1), DISC_substrate_binding_C8pro_0_2kf, DISC_substrate_binding_C8pro_0_1kr)
...
Rule('BAR_inhibition_DISC_0', BAR(DISC=None) + DISC(C8pro=None, BAR=None, flip=None) <> BAR(DISC=1) % DISC(C8pro=None, BAR=1, flip=None), BAR_inhibition_DISC_0_2kf, BAR_inhibition_DISC_0_1kr)
Rule('L_R_dimerization_DISC_0', L(R=1) % R(L=1) >> DISC(C8pro=None, BAR=None, flip=None), L_R_dimerization_DISC_0_1kc)
Rule('flip_inhibition_DISC_0', flip(DISC=None) + DISC(C8pro=None, BAR=None, flip=None) <> flip(DISC=1) % DISC(C8pro=None, BAR=None, flip=1), flip_inhibition_DISC_0_2kf, flip_inhibition_DISC_0_1kr)
...
Rule('C8A_BidU_catalysis_BidT_0', C8A(BidU=1, C3pro=None) % BidU(C8A=1) >> C8A(BidU=None, C3pro=None) + BidT(), C8A_BidU_catalysis_BidT_0_1kc)
Rule('C8A_substrate_binding_BidU_0', C8A(BidU=None, C3pro=None) + BidU(C8A=None) <> C8A(BidU=1, C3pro=None) % BidU(C8A=1), C8A_substrate_binding_BidU_0_2kf, C8A_substrate_binding_BidU_0_1kr)
Rule('C8A_C3pro_catalysis_C3A_0', C8A(BidU=None, C3pro=1) % C3pro(C8A=1) >> C8A(BidU=None, C3pro=None) + C3A(XIAP=None, PARPU=None, C6pro=None, Apop=None), C8A_C3pro_catalysis_C3A_0_1kc)
...
Rule('C8A_substrate_binding_C3pro_0', C8A(BidU=None, C3pro=None) + C3pro(C8A=None) <> C8A(BidU=None, C3pro=1) % C3pro(C8A=1), C8A_substrate_binding_C3pro_0_2kf, C8A_substrate_binding_C3pro_0_1kr)
