# exported from PySB model 'model_222'
...
Rule('C8A_substrate_binding_C3pro_0', C8A(BidU=None, C3pro=None) + C3pro(Apop=None, C8A=None) <> C8A(BidU=None, C3pro=1) % C3pro(Apop=None, C8A=1), C8A_substrate_binding_C3pro_0_2kf, C8A_substrate_binding_C3pro_0_1kr)
