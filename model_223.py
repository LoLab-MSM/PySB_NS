# exported from PySB model 'model_223'
...
Rule('C8A_C3pro_catalysis_C3A_0', C8A(BidU=None, C3pro=1) % C3pro(C8A=1, Apop=None) >> C8A(BidU=None, C3pro=None) + C3A(XIAP=None, PARPU=None, C6pro=None), C8A_C3pro_catalysis_C3A_0_1kc)
...
Rule('C8A_substrate_binding_C3pro_0', C8A(BidU=None, C3pro=None) + C3pro(C8A=None, Apop=None) <> C8A(BidU=None, C3pro=1) % C3pro(C8A=1, Apop=None), C8A_substrate_binding_C3pro_0_2kf, C8A_substrate_binding_C3pro_0_1kr)
