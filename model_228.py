# exported from PySB model 'model_228'
...
Rule('DISC_C8pro_catalysis_C8A_0', DISC(C8pro=1, BAR=None, flip=None) % C8pro(DISC=1, C6A=None) >> DISC(C8pro=None, BAR=None, flip=None) + C8A(BidU=None, C3pro=None), DISC_C8pro_catalysis_C8A_0_1kc)
Rule('DISC_substrate_binding_C8pro_0', DISC(C8pro=None, BAR=None, flip=None) + C8pro(DISC=None, C6A=None) <> DISC(C8pro=1, BAR=None, flip=None) % C8pro(DISC=1, C6A=None), DISC_substrate_binding_C8pro_0_2kf, DISC_substrate_binding_C8pro_0_1kr)
