# exported from PySB model 'model_233'
...
Rule('DISC_C8pro_catalysis_C6A_0', DISC(C8pro=1, BAR=None, flip=None) % C8pro(C6A=None, DISC=1) >> DISC(C8pro=None, BAR=None, flip=None) + C6A(C8pro=None), DISC_C8pro_catalysis_C6A_0_1kc)
