# exported from PySB model 'model_91'
...
Rule('BidT_equilibration_BclxLM_0', BidT() <> BclxLM(BakA=None, BaxA=None, Mcl1M=None, BadM=None), BidT_equilibration_BclxLM_0_1kf, BidT_equilibration_BclxLM_0_1kr)
